...
class KeyTeleop():
    ...
    def __init__(self, interface):
        ...
        self._num_steps = rospy.get_param('~turbo/steps', 5)

        forward_min = rospy.get_param('~turbo/linear_forward_min', 20.0)
        forward_max = rospy.get_param('~turbo/linear_forward_max', 100.0)
        self._forward = Velocity(forward_min, forward_max, self._num_steps)

        backward_min = rospy.get_param('~turbo/linear_backward_min', 20.0)
        backward_max = rospy.get_param('~turbo/linear_backward_max', 100.0)
        self._backward = Velocity(backward_min, backward_max, self._num_steps)

        angular_min = rospy.get_param('~turbo/angular_min', 20.0)
        angular_max = rospy.get_param('~turbo/angular_max', 100.0)

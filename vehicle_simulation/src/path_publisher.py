...
def parse_path_file(filepath = '/home/nvidia/catkin_ws/src/vehicle_simulation/src/pid_waypoints.txt'):
	print filepath
	cx = []
	cy = []
...
def coordinates_to_msg(cx, cy):
	...
	for x, y in zip(cx, cy):
		...
		pose.pose.position.x = x *1.1+ 1.1
		pose.pose.position.y = y *1.1
